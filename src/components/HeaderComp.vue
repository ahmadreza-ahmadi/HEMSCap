  ...
  <header class="flex justify-between items-center">
    <div class="flex items-center gap-3 sm:gap-4">
      <img
        ...
        alt="profile"
        class="w-12 sm:w-20 rounded-full"
      />
      <div class="flex flex-col sm:gap-1">
        <h3 class="text-xl sm:text-3xl capitalize">Hi milad, welcome</h3>
        <p class="text-sm sm:text-lg text-neutral-light-70 first-letter:capitalize">
          you have 3 task today
        </p>
      </div>
    </div>
    <button
      class="relative p-[6px] sm:p-2 rounded-[5px] bg-neutral-light-10 border-[0.5px] border-neutral-light-80"
    >
      <svg
        class="fill-neutral-light-80 w-5 sm:w-6 h-5 sm:h-6"
        width="24"
        height="24"
        viewBox="0 0 24 24"
        fill="none"
